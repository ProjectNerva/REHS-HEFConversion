...
If you have an NVIDIA GPU on a Linux host, you can pass it through to the container to speed up the quantization calibration step. macOS Docker Desktop cannot pass NVIDIA GPUs through to containers — CPU-only mode is used automatically there.
